...
const Popup: FC = () => {
  ...
  return (
    <div
      className={`fixed top-32 px-5 py-2 rounded-lg min-w-60 justify-between items-center mobile:top-20 text-white gap-20 mobile:gap-5 transition-all duration-300 flex
        ${
